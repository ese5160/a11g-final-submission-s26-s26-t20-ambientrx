...
![alt text](image/A11G/Finalproject-casework.png)
### The standalone PCBA, top
![alt text](image/A11G/StandalonePCBA-top.png)
### The standalone PCBA, bottom
![alt text](image/A11G/StandalonePCBA-Bottom.png)
### Thermal camera images while the board is running under load (you may use your Board Bringup Thermal image here!)
![alt text](image/A11G/Load10.png)
![alt text](image/A11G/Load50.png)
![alt text](image/A11G/Load100.png)
![alt text](image/A11G/Load120.png)
### The Altium Board design in 2D view (screenshot)
![alt text](image/A11G/pcbdesign-2d-topplane.png)
![alt text](image/A11G/pcbdesign-2d-bottomplane.png)
### The Altium Board design in 3D view (screenshot)
![alt text](image/A11G/pcbdesign-3d-topplane.png)
![alt text](image/A11G/pcbdesign-3d-bottomplane.png)
### Node-RED dashboard (screenshot)
![alt text](image/A11G/Nodered-frontend1.png)
![alt text](image/A11G/Nodered-frontend2.png)

### Node-RED backend (screenshot)
![alt text](image/A11G/Nodered-backend1.png)
![alt text](image/A11G/Nodered-backend2.png)
![alt text](image/A11G/Nodered-backend3.png)

### Block diagram of your system (You may need to update this to reflect changes throughout the semester.)
![alt text](image/A11G/BlockDiagram.png)
